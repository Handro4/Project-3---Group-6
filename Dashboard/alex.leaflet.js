    ...
    d3.csv("../Data_Cleaning/max_aqi_csv.csv").then(function (data) {
        ...
        function createLegend() {
            ...
            legend.onAdd = function (map) {
                ...
                const categories = ["Good", "Moderate", "Unhealthy for Sensitive Groups", "Unhealthy", "Very Unhealthy", "Hazardous"]; // Define your categories here
                const colors = ['#24E228', '#FFFD38', '#FE7E23', '#FB0D1C', '#8D4295', '#7D0425']; // Define your colors here
        ...
        d3.csv("../Resources/aqi_cdi.csv").then(function (cdi_data) {
            ...
            function updateScatterPlot(selectedTopic, selectedParameter) {
                ...
                let xValues = filteredData.map(d => d[selectedParameter]);
                let yValues = filteredData.map(d => d.DataValue);
